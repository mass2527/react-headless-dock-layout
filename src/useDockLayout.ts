...
export function useDockLayout<T extends HTMLElement>(
  ...
  return {
    ...
    getRectProps: useCallback(
      ...
      [containerRef, draggingRect, layoutManager, resizingRect],
    ),
    /**
     ...
     */
    getDropIndicatorProps: useCallback(
     ...
     */
    getDragHandleProps: useCallback((rect: PanelLayoutRect) => {
      return {
        onPointerDown: (event: ReactPointerEvent) => {
          event.currentTarget.releasePointerCapture(event.pointerId);
    ...
    addPanel: useCallback(
      (id: string) => layoutManager.addPanel(id),
      [layoutManager],
    ),
    /**
    ...
    removePanel: useCallback(
      (id: string) => layoutManager.removePanel(id),
      [layoutManager],
    ),
    /**
